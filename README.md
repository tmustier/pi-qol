...
| [`git:github.com/mitsuhiko/agent-stuff`](https://github.com/mitsuhiko/agent-stuff) | Armin's pack. I use `notify`, `context`, `session-breakdown`, `review`, and `whimsical` (random delightful "Combobulating..."-style spinner messages). |
...
- [@mitsuhiko (Armin Ronacher)](https://github.com/mitsuhiko) — `agent-stuff` (`notify`, `context`, `session-breakdown`, `review`, `whimsical`).
